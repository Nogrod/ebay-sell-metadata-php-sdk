...
/**
 * SortOrderInner Class Doc Comment
 *
 ...
 */
class SortOrderInner implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'SortOrderInner';
    ...
    protected static array $openAPITypes = [
        'sort_order' => '\eBay\Sell\Metadata\Model\SortOrderProperties',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sort_priority', $data ?? [], null);
    }
     ...
     * Gets sort_order
     *
     * @return \eBay\Sell\Metadata\Model\SortOrderProperties|null
     */
    public function getSortOrder(): ?\eBay\Sell\Metadata\Model\SortOrderProperties
    {
     ...
     * Sets sort_order
     *
     * @param \eBay\Sell\Metadata\Model\SortOrderProperties|null $sort_order This container is used to define the property to be used in the sorting.
     *
     * @return $this
     */
    public function setSortOrder(?\eBay\Sell\Metadata\Model\SortOrderProperties $sort_order): static
    {
     ...
     * @return string|null
     */
    public function getSortPriority(): ?string
    {
     ...
     * Sets sort_priority
     *
     * @param string|null $sort_priority The priority of the specified sort order provided.<br><br>For example, when a property is assigned <code>Sort1</code>, its values are sorted first. Values for the property assigned <code>Sort2</code> are sorted second, and so on.<br><br><b>Valid values</b>:<ul><li><code>Sort1</code></li><li><code>Sort2</code></li><li><code>Sort3</code></li><li><code>Sort4</code></li><li><code>Sort5</code></li></ul>
     *
     * @return $this
     */
    public function setSortPriority(?string $sort_priority): static
    {
        if (is_null($sort_priority)) {
            throw new InvalidArgumentException('non-nullable sort_priority cannot be null');
        }
