...
class ShippingCarrier implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ShippingCarrier';
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description The localized description of the shipping carrier, such as <code>UPS</code>, <code>FedEx</code>, and <code>USPS</code>.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $shipping_carrier An enumerated value describing the shipping carrier returned, for example, <code>UPS</code>, <code>FedEx</code>, and <code>USPS</code>. These values are needed when providing shipment tracking information for each specific shipping carrier.
     *
     * @return $this
     */
