...
class MotorsListingPolicy implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     *
     * @param bool|null $local_market_speciality_subscription Indicates whether the category supports the Specialty level subscription to Motors Local Market listings. This feature is only available to licensed vehicle dealers.
     *
     * @return $this
     */
