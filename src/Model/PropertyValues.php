...
/**
 * PropertyValues Class Doc Comment
 *
 ...
 */
class PropertyValues implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PropertyValues';
    ...
    */
     ...
     * Sets property_name
     *
     * @param string|null $property_name The name of the property.<br><br>For example, typical vehicle property names are 'Make', 'Model', 'Year', 'Engine', and 'Trim', but will vary based on the eBay marketplace and the eBay category.
     *
     * @return $this
     */
     ...
     * Sets property_value
     *
     * @param string|null $property_value The value for the property specified in the <b>properyName</b> field.<br><br>For example, if the <b>propertyName</b> is <code>make</code>, then the <b>propertyValue</b> will be the specific make of the vehicle, such as <code>Toyota</code>.
     *
     * @return $this
     */
