...
class SpecificationRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['specifications'] === null) {
            $invalidProperties[] = "'specifications' can't be null";
        }
     ...
     *
     * @param \eBay\Sell\Metadata\Model\PaginationInput|null $pagination_input <div class=\"msgbox_important\"><p class=\"msgbox_importantInDiv\" data-mc-autonum=\"&lt;b&gt;&lt;span style=&quot;color: #dd1e31;&quot; class=&quot;mcFormatColor&quot;&gt;Important! &lt;/span&gt;&lt;/b&gt;\"><span class=\"autonumber\"><span><b><span style=\"color: #dd1e31;\" class=\"mcFormatColor\">Important!</span></b></span></span> Pagination is not yet supported by this method. If this container is included in the request, it will be ignored.</p></div>
     *
     * @return $this
     */
     ...
     * Gets specifications
     *
     * @return \eBay\Sell\Metadata\Model\PropertyFilterInner[]
     */
     ...
     * Sets specifications
     *
     * @param \eBay\Sell\Metadata\Model\PropertyFilterInner[] $specifications This array defines the specifications of the part, in the form of name-value pairs, for which compatible applications will be retrieved.
     *
     * @return $this
     */
