...
class HazardStatement implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets statement_id
     *
     * @param string|null $statement_id The identifier of the statement. For sample values, see <a href='/api-docs/sell/static/metadata/feature-regulatorhazmatcontainer.html#Hazard'>Hazard statement sample values</a>.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $statement_description The description of the statement localized to the default language of the marketplace. For sample values, see <a href='/api-docs/sell/static/metadata/feature-regulatorhazmatcontainer.html#Hazard'>Hazard statement sample values</a>.
     *
     * @return $this
     */
