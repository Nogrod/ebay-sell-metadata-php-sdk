...
class ItemConditionDescriptor implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     *
     * @param \eBay\Sell\Metadata\Model\ItemConditionDescriptorConstraint|null $condition_descriptor_constraint This container shows the constraints on a condition descriptor, such as the maximum length, default condition descriptor value ID, cardinality, mode, usage, and applicable descriptor IDs.
     *
     * @return $this
     */
