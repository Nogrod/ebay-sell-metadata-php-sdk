 ...
 *
 * @description This type contains applicable return policy metadata for the leaf categories returned for the marketplace.
 * @package  eBay\Sell\Metadata
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ReturnPolicy implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     */
    public function getDomestic(): ?\eBay\Sell\Metadata\Model\ReturnPolicyDetails
    {
     ...
     * Sets domestic
     *
     * @param \eBay\Sell\Metadata\Model\ReturnPolicyDetails|null $domestic This complex type defines the category policies related to domestic item returns.
     *
     * @return $this
     */
    public function setDomestic(?\eBay\Sell\Metadata\Model\ReturnPolicyDetails $domestic): static
    {
        if (is_null($domestic)) {
     ...
     * @return \eBay\Sell\Metadata\Model\ReturnPolicyDetails|null
     */
    public function getInternational(): ?\eBay\Sell\Metadata\Model\ReturnPolicyDetails
    {
     ...
     * Sets international
     *
     * @param \eBay\Sell\Metadata\Model\ReturnPolicyDetails|null $international This complex type defines the category policies related to international item returns.
     *
     * @return $this
     */
    public function setInternational(?\eBay\Sell\Metadata\Model\ReturnPolicyDetails $international): static
    {
     ...
     * Sets required
     *
     * @param bool|null $required If set to <code>true</code>, this flag indicates that you must specify a return policy for items listed in the associated category.  <br><br>Note that not accepting returns (setting <b>returnsAcceptedEnabled</b> to <code>false</code>) is a valid return policy.
     *
     * @return $this
     */
