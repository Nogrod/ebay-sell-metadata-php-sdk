...
class CategoryPolicy implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $attributeMap = [
        ...
        'reserve_price_allowed' => 'reservePriceAllowed',
    ...
    protected static array $setters = [
        ...
        'reserve_price_allowed' => 'setReservePriceAllowed',
    ...
    protected static array $getters = [
        ...
        'reserve_price_allowed' => 'getReservePriceAllowed',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('reserve_price_allowed', $data ?? [], null);
        $this->setIfExists('upc_support', $data ?? [], null);
        $this->setIfExists('value_category', $data ?? [], null);
     ...
     *
     * @param bool|null $b2b_vat_enabled If this field is returned as true, the corresponding category supports business-to-business (B2B) VAT listings. If this field is not present, the category does not B2B VAT listings. This field is not returned when false. This feature is applicable to the eBay Germany (DE), Austria (AT), and Switzerland (CH) sites only.
     *
     * @return $this
     */
     ...
     * Sets expired
     *
     * @param bool|null $expired If this field is returned as true, the corresponding category is no longer a valid eBay category on the site, and items may not be listed in this category. This field is not returned when false.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $intangible_enabled If this field is returned as true, the category supports the listing of intangible goods or services.
     *
     * @return $this
     */
     ...
     *
     * @param float|null $minimum_reserve_price Indicates the Minimum Reserve Price for an auction listing in this category. If there is no Minimum Reserve Price, a value of 0.0 is returned in this field.
     *
     * @return $this
     */
     ...
     * Sets orpa
     *
     * @param bool|null $orpa This field (Override Reserve Price Allowed) is returned as true if the eBay marketplace's default policy is to allow reserve prices for auction listings, but the corresponding category does not allow a reserve price. This field is not returned if the marketplace does not permit reserve prices.
     *
     * @return $this
     */
    ...
    /**
     * Gets reserve_price_allowed
     *
     * @return bool|null
     */
    public function getReservePriceAllowed(): ?bool
    {
        return $this->container['reserve_price_allowed'];
    }

    /**
     * Sets reserve_price_allowed
     *
     * @param bool|null $reserve_price_allowed This field indicates whether reserve prices are allowed for auction listings in this category. This field returns as true when the category supports reserve prices, or false if the eBay marketplace does not permit reserve prices or the category override blocks reserve prices (orpa is true).
     *
     * @return $this
     */
    public function setReservePriceAllowed(?bool $reserve_price_allowed): static
    {
        if (is_null($reserve_price_allowed)) {
            throw new InvalidArgumentException('non-nullable reserve_price_allowed cannot be null');
        }
        $this->container['reserve_price_allowed'] = $reserve_price_allowed;
     ...
     * Sets value_category
     *
     * @param bool|null $value_category When returned as <code>true</code>, this boolean indicates that the leaf category for the specified site is designated by eBay as a value category. Value categories can be used as a secondary category for a listing at no extra charge.
     *
     * @return $this
     */
    public function setValueCategory(?bool $value_category): static
    {
        if (is_null($value_category)) {
            throw new InvalidArgumentException('non-nullable value_category cannot be null');
        }
     ...
     * Sets virtual
     *
     * @param bool|null $virtual If this field is returned as true, the corresponding category is an eBay virtual category, a category in which items may not be listed. This field is not returned when false.
     *
     * @return $this
     */
