 ...
 *
 * @description This type provides fields that contain applicable Classified Ad policy metadata for the leaf categories returned for the marketplace.
 * @package  eBay\Sell\Metadata
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ClassifiedAdPolicy implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     *
     * @param bool|null $classified_ad_company_name_enabled Indicates whether this category supports including a company name in the seller's contact information. This element is for For Sale By Owner listings.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $classified_ad_contact_by_address_enabled Indicates whether this category supports including an address in the seller's contact information. This element is for For Sale By Owner listings.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $classified_ad_counter_offer_enabled Indicates whether counter offers are allowed on Best Offers for most categories.
     *
     * @return $this
     */
