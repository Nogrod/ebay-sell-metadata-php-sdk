 ...
 */
class ItemConditionDescriptorValueConstraint implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ItemConditionDescriptorValueConstraint';
    ...
    protected static array $openAPINullables = [
        'applicable_to_condition_descriptor_id' => false,
        'applicable_to_condition_descriptor_value_ids' => false
    ];
    ...
    {
        $this->setIfExists('applicable_to_condition_descriptor_id', $data ?? [], null);
        $this->setIfExists('applicable_to_condition_descriptor_value_ids', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getApplicableToConditionDescriptorId(): ?string
    {
     ...
     *
     * @param string|null $applicable_to_condition_descriptor_id This string is returned if the corresponding condition descriptor value requires an associated condition descriptor that must also be specified in a listing. The condition descriptor ID for the associated condition descriptors is returned here.
     *
     * @return $this
     */
    public function setApplicableToConditionDescriptorId(?string $applicable_to_condition_descriptor_id): static
    {
        if (is_null($applicable_to_condition_descriptor_id)) {
            throw new InvalidArgumentException('non-nullable applicable_to_condition_descriptor_id cannot be null');
        }
     ...
     * @return string[]|null
     */
    public function getApplicableToConditionDescriptorValueIds(): ?array
    {
     ...
     *
     * @param string[]|null $applicable_to_condition_descriptor_value_ids This array is returned if the corresponding condition descriptor value is required for one or more associated condition descriptor values that must also be specified in a listing. The condition descriptor values IDs for the associated condition descriptor values are returned here.
     *
     * @return $this
     */
    public function setApplicableToConditionDescriptorValueIds(?array $applicable_to_condition_descriptor_value_ids): static
    {
        if (is_null($applicable_to_condition_descriptor_value_ids)) {
            throw new InvalidArgumentException('non-nullable applicable_to_condition_descriptor_value_ids cannot be null');
        }
