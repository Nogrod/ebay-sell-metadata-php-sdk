...
/**
 * PropertyNamesResponsePropertyNameMetadata Class Doc Comment
 *
 ...
 */
class PropertyNamesResponsePropertyNameMetadata implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PropertyNamesResponsePropertyNameMetadata';
    ...
    {
        $this->setIfExists('display_sequence', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param int|null $display_sequence The numeric value indicating the ordering position of the property.
     *
     * @return $this
     */
    public function setDisplaySequence(?int $display_sequence): static
    {
        if (is_null($display_sequence)) {
            throw new InvalidArgumentException('non-nullable display_sequence cannot be null');
        }
