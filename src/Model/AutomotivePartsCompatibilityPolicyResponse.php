 ...
 *
 * @description The base response type of the &lt;b&gt;AutomotivePartsCompatibilityPolicy&lt;/b&gt; method.
 * @package  eBay\Sell\Metadata
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class AutomotivePartsCompatibilityPolicyResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AutomotivePartsCompatibilityPolicyResponse';
    ...
    protected static array $openAPINullables = [
        'automotive_parts_compatibility_policies' => false,
        'warnings' => false
    ];
    ...
    {
        $this->setIfExists('automotive_parts_compatibility_policies', $data ?? [], null);
     ...
     */
    public function getAutomotivePartsCompatibilityPolicies(): ?array
    {
     ...
     * @return $this
     */
    public function setAutomotivePartsCompatibilityPolicies(?array $automotive_parts_compatibility_policies): static
    {
        if (is_null($automotive_parts_compatibility_policies)) {
            throw new InvalidArgumentException('non-nullable automotive_parts_compatibility_policies cannot be null');
        }
