 ...
 *
 * @description This type defines the base response fields of the &lt;b&gt;getListingStructuresPolicies&lt;/b&gt; method.
 * @package  eBay\Sell\Metadata
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ListingStructurePolicyResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ListingStructurePolicyResponse';
    ...
    protected static array $openAPINullables = [
        'listing_structure_policies' => false,
        'warnings' => false
    ];
    ...
    {
        $this->setIfExists('listing_structure_policies', $data ?? [], null);
     ...
     */
    public function getListingStructurePolicies(): ?array
    {
     ...
     * @return $this
     */
    public function setListingStructurePolicies(?array $listing_structure_policies): static
    {
        if (is_null($listing_structure_policies)) {
            throw new InvalidArgumentException('non-nullable listing_structure_policies cannot be null');
        }
     ...
     * Sets warnings
     *
     * @param \eBay\Sell\Metadata\Model\ErrorDetailV3[]|null $warnings Collection of warnings generated for the request
     *
     * @return $this
     */
