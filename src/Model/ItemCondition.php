...
class ItemCondition implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets condition_id
     *
     * @param string|null $condition_id The ID value of the selected item condition. For information on the supported condition ID values, see <a href='/api-docs/sell/static/metadata/condition-id-values.html' target='_blank'>Item condition ID and name values</a>.
     *
     * @return $this
     */
