...
/**
 * PropertyValuesRequest Class Doc Comment
 *
 ...
 */
class PropertyValuesRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PropertyValuesRequest';
    ...
    */
     ...
     * Sets sort_order
     *
     * @param string|null $sort_order This field specifies the sort order for the property values in the result set.<br><br><b>Valid values:</b><ul><li><code>Ascending</code></li><li>Descending</li></ul><span class=\"tablenote\"><b>Note:</b> If no search order is specified, values are sorted in ascending order.</span>
     *
     * @return $this
     */
