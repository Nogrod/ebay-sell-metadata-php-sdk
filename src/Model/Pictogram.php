...
class Pictogram implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets pictogram_id
     *
     * @param string|null $pictogram_id The identifier of the pictogram. For sample values, see <a href='/api-docs/sell/static/metadata/feature-regulatorhazmatcontainer.html#Pictogra'>Pictogram sample values</a>.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $pictogram_description The description of the pictogram localized to the default language of the marketplace. For sample values, see <a href='/api-docs/sell/static/metadata/feature-regulatorhazmatcontainer.html#Pictogra'>Pictogram sample values</a>.
     *
     * @return $this
     */
