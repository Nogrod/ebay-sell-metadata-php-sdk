 ...
 */
class ProductSafetyLabelStatement implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductSafetyLabelStatement';
    ...
    */
     ...
     *
     * @param string|null $statement_description The description of the statement localized to the default language of the marketplace.
     *
     * @return $this
     */
     ...
     * Sets statement_id
     *
     * @param string|null $statement_id The identifier of the statement.
     *
     * @return $this
     */
