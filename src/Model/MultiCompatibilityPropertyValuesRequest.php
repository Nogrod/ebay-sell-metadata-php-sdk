...
class MultiCompatibilityPropertyValuesRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['property_filters'] === null) {
            $invalidProperties[] = "'property_filters' can't be null";
        }
        if ($this->container['property_names'] === null) {
            $invalidProperties[] = "'property_names' can't be null";
        }
     ...
     * Sets category_id
     *
     * @param string $category_id The unique identifier of the eBay leaf category for which to retrieve property values.<br><br>Use the <a href=\"/develop/api/sell/metadata_api#sell-metadata_api-marketplace-getautomotivepartscompatibilitypolicies\">getAutomotivePartsCompatibilityPolicies</a> method to retrieve a list of categories that support parts compatibility.
     *
     * @return $this
     */
     ...
     * Sets property_names
     *
     * @param string[] $property_names This comma-delimited array specifies the names of the properties for which to retrieve associated property values.<br><br>For example, typical vehicle property names are 'Make', 'Model', 'Year', 'Engine', and 'Trim', but will vary based on the eBay marketplace and the eBay category.
     *
     * @return $this
     */
