...
class Currency implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description The description of the returned three-letter code. For example, if the code is <code>USD</code>, the description returned would be <code>US Dollar</code>.
     *
     * @return $this
     */
