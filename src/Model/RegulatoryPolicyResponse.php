 ...
 */
class RegulatoryPolicyResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'RegulatoryPolicyResponse';
    ...
    protected static array $openAPITypes = [
        'regulatory_policies' => '\eBay\Sell\Metadata\Model\RegulatoryPolicy[]',
    ...
    {
        $this->setIfExists('regulatory_policies', $data ?? [], null);
     ...
     *
     * @return \eBay\Sell\Metadata\Model\RegulatoryPolicy[]|null
     */
    public function getRegulatoryPolicies(): ?array
    {
     ...
     *
     * @param \eBay\Sell\Metadata\Model\RegulatoryPolicy[]|null $regulatory_policies A list of eBay policies that define whether or not you must include required regulatory information for leaf categories on the given marketplace.
     *
     * @return $this
     */
    public function setRegulatoryPolicies(?array $regulatory_policies): static
    {
        if (is_null($regulatory_policies)) {
            throw new InvalidArgumentException('non-nullable regulatory_policies cannot be null');
        }
