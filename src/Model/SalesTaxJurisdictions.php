...
class SalesTaxJurisdictions implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SalesTaxJurisdictions';
    ...
    {
        $this->setIfExists('sales_tax_jurisdictions', $data ?? [], null);
    }
    ...
    */
     ...
     */
    public function getSalesTaxJurisdictions(): ?array
    {
     ...
     * @return $this
     */
    public function setSalesTaxJurisdictions(?array $sales_tax_jurisdictions): static
    {
        if (is_null($sales_tax_jurisdictions)) {
            throw new InvalidArgumentException('non-nullable sales_tax_jurisdictions cannot be null');
        }
