 ...
 *
 * @description This type defines the base response fields of the &lt;b&gt;getNegotiatedPricePolicies&lt;/b&gt; method.
 * @package  eBay\Sell\Metadata
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class NegotiatedPricePolicyResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'NegotiatedPricePolicyResponse';
    ...
    protected static array $openAPINullables = [
        'negotiated_price_policies' => false,
        'warnings' => false
    ];
    ...
    {
        $this->setIfExists('negotiated_price_policies', $data ?? [], null);
     ...
     */
    public function getNegotiatedPricePolicies(): ?array
    {
     ...
     * @return $this
     */
    public function setNegotiatedPricePolicies(?array $negotiated_price_policies): static
    {
        if (is_null($negotiated_price_policies)) {
            throw new InvalidArgumentException('non-nullable negotiated_price_policies cannot be null');
        }
