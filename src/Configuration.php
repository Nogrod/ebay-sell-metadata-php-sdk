...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'https://api.ebay.com/sell/metadata/v1';
    ...
    {
        $report  = 'PHP SDK (eBay\Sell\Metadata) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: v1.11.1' . PHP_EOL;
            ...
            [
                ...
                "variables" => [
                    "basePath" => [
                        ...
                        "default_value" => "/sell/metadata/v1",
                    ]
                ]
            ]
        ];
