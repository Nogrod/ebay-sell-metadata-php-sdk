...
use eBay\Sell\Metadata\Model\ModelInterface;
...
class ObjectSerializer
{
    ...
    public static function deserialize(mixed $data, string $class, ?array $httpHeaders = null): mixed
    {
        ...
        if (is_subclass_of($class, '\BackedEnum')) {
            ...
            if (is_subclass_of($class, '\eBay\Sell\Metadata\Model\OneOfInterface')) {
                return self::deserializeOneOf($data, $class, $httpHeaders);
            }
            if (is_subclass_of($class, '\eBay\Sell\Metadata\Model\AnyOfInterface')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\eBay\Sell\Metadata\Model\\' . $data->{$discriminator};
