...
class CompatibilitiesApi
{
     ...
     *
     * @param  string $x_ebay_c_marketplace_id This header identifies the seller&#39;s eBay marketplace.&lt;br&gt;&lt;br&gt;See &lt;a href&#x3D;\&quot;/develop/api/sell/request_headers#marketplace-id-values\&quot; target&#x3D;\&quot;_blank \&quot;&gt;Marketplace ID values&lt;/a&gt; for a list of supported eBay marketplace ID values. (required)
     ...
     * @return \eBay\Sell\Metadata\Model\SpecificationResponse|null
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \eBay\Sell\Metadata\Model\SpecificationResponse|null, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    ...
    public function getCompatibilitiesBySpecificationRequest(
        ...
        if (isset($specification_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($specification_request), JSON_THROW_ON_ERROR);
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \eBay\Sell\Metadata\Model\PropertyNamesResponse|null
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \eBay\Sell\Metadata\Model\PropertyNamesResponse|null, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    ...
    public function getCompatibilityPropertyNamesRequest(
        ...
        if (isset($property_names_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($property_names_request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \eBay\Sell\Metadata\Model\PropertyValuesResponse|null
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \eBay\Sell\Metadata\Model\PropertyValuesResponse|null, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    ...
    public function getCompatibilityPropertyValuesRequest(
        ...
        if (isset($property_values_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($property_values_request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \eBay\Sell\Metadata\Model\MultiCompatibilityPropertyValuesResponse|null
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \eBay\Sell\Metadata\Model\MultiCompatibilityPropertyValuesResponse|null, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    ...
    public function getMultiCompatibilityPropertyValuesRequest(
        ...
        if (isset($multi_compatibility_property_values_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($multi_compatibility_property_values_request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \eBay\Sell\Metadata\Model\ProductResponse|null
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \eBay\Sell\Metadata\Model\ProductResponse|null, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    ...
    public function getProductCompatibilitiesRequest(
        ...
        if (isset($product_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($product_request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
