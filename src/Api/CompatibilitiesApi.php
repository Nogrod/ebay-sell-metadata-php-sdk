            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\eBay\Sell\Metadata\Model\SpecificationResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        ...
                        if ('\eBay\Sell\Metadata\Model\SpecificationResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eBay\Sell\Metadata\Model\SpecificationResponse', []),
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\eBay\Sell\Metadata\Model\PropertyNamesResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        ...
                        $content = (string) $response->getBody();
                        if ('\eBay\Sell\Metadata\Model\PropertyNamesResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eBay\Sell\Metadata\Model\PropertyNamesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\eBay\Sell\Metadata\Model\PropertyValuesResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        ...
                        $content = (string) $response->getBody();
                        if ('\eBay\Sell\Metadata\Model\PropertyValuesResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eBay\Sell\Metadata\Model\PropertyValuesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\eBay\Sell\Metadata\Model\MultiCompatibilityPropertyValuesResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        ...
                        $content = (string) $response->getBody();
                        if ('\eBay\Sell\Metadata\Model\MultiCompatibilityPropertyValuesResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eBay\Sell\Metadata\Model\MultiCompatibilityPropertyValuesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\eBay\Sell\Metadata\Model\ProductResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        ...
                        $content = (string) $response->getBody();
                        if ('\eBay\Sell\Metadata\Model\ProductResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eBay\Sell\Metadata\Model\ProductResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
