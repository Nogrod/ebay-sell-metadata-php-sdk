...
------------ | ------------- | ------------- | -------------
**condition_descriptor_constraint** | [**\eBay\Sell\Metadata\Model\ItemConditionDescriptorConstraint**](ItemConditionDescriptorConstraint.md) | This container shows the constraints on a condition descriptor, such as the maximum length, default condition descriptor value ID, cardinality, mode, usage, and applicable descriptor IDs. | [optional]
