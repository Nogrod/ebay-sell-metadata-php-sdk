...
**warnings** | [**\eBay\Sell\Metadata\Model\ErrorDetailV3[]**](ErrorDetailV3.md) | A list of the warnings that were generated as a result of the request. This field is not returned if no warnings were generated by the request. | [optional]
