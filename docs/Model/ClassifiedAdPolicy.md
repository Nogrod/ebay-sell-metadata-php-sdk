...
------------ | ------------- | ------------- | -------------
**ad_format_enabled** | [**\eBay\Sell\Metadata\Model\AdFormatEnabledEnum**](AdFormatEnabledEnum.md) | This enumerated value indicates the type or status of available Classified Ad formats for this category. | [optional]
...
**classified_ad_best_offer_enabled** | [**\eBay\Sell\Metadata\Model\ClassifiedAdBestOfferEnabledEnum**](ClassifiedAdBestOfferEnabledEnum.md) | This enumerated value indicates if Best Offer is enabled, disabled, or required for Classified Ad listings in this category. | [optional]
**classified_ad_company_name_enabled** | **bool** | Indicates whether this category supports including a company name in the seller&#39;s contact information. This element is for For Sale By Owner listings. | [optional]
**classified_ad_contact_by_address_enabled** | **bool** | Indicates whether this category supports including an address in the seller&#39;s contact information. This element is for For Sale By Owner listings. | [optional]
...
**classified_ad_counter_offer_enabled** | **bool** | Indicates whether counter offers are allowed on Best Offers for most categories. | [optional]
**classified_ad_payment_method_enabled** | [**\eBay\Sell\Metadata\Model\ClassifiedAdPaymentMethodEnabledEnum**](ClassifiedAdPaymentMethodEnabledEnum.md) | This enumerated value indicates support for the payment method being displayed to the user for the category. Even if enabled, checkout may or may not be enabled. | [optional]
