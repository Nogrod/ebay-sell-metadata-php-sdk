...
**compatibility_based_on** | [**\eBay\Sell\Metadata\Model\CompatibilityTypeEnum**](CompatibilityTypeEnum.md) | Indicates whether the category supports parts compatibility by either &lt;code&gt;ASSEMBLY&lt;/code&gt; or by &lt;code&gt;SPECIFICATION&lt;/code&gt;.&lt;br&gt;&lt;br&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;b&gt;Note:&lt;/b&gt; Only categories returning the &lt;b&gt;compatibilityBasedOn&lt;/b&gt; field support compatibility. Categories where all compatibility fields are missing, or where only &lt;b&gt;compatibilityBasedOn&lt;/b&gt; is missing, should be considered as not supporting compatibility.&lt;/span&gt; | [optional]
**compatible_vehicle_types** | [**\eBay\Sell\Metadata\Model\CompatibleVehicleTypeEnum[]**](CompatibleVehicleTypeEnum.md) | Indicates the compatibility classification of the part based on high-level vehicle types. | [optional]
