...
/**
 * DescriptorUsageEnumTest Class Doc Comment
 *
 * @description This enumeration type indicates if there are any usage restrictions for the corresponding condition descriptor in the corresponding category. Currently, the only supported value is &lt;code&gt;REQUIRED&lt;/code&gt;. | - **REQUIRED**: This value indicates that the usage of the condition descriptor in the corresponding category is required.
 * @package     eBay\Sell\Metadata
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 */
class DescriptorUsageEnumTest extends TestCase
{
    ...
    /**
     * Test "DescriptorUsageEnum"
     */
    public function testDescriptorUsageEnum()
    {
        // TODO: implement
