...
*ShippingMarketplaceApi* | [**getExcludeShippingLocations**](docs/Api/ShippingMarketplaceApi.md#getexcludeshippinglocations) | **GET** /shipping/marketplace/{marketplace_id}/get_exclude_shipping_locations | 
*ShippingMarketplaceApi* | [**getHandlingTimes**](docs/Api/ShippingMarketplaceApi.md#gethandlingtimes) | **GET** /shipping/marketplace/{marketplace_id}/get_handling_times | 
*ShippingMarketplaceApi* | [**getShippingCarriers**](docs/Api/ShippingMarketplaceApi.md#getshippingcarriers) | **GET** /shipping/marketplace/{marketplace_id}/get_shipping_carriers | 
*ShippingMarketplaceApi* | [**getShippingLocations**](docs/Api/ShippingMarketplaceApi.md#getshippinglocations) | **GET** /shipping/marketplace/{marketplace_id}/get_shipping_locations | 
*ShippingMarketplaceApi* | [**getShippingServices**](docs/Api/ShippingMarketplaceApi.md#getshippingservices) | **GET** /shipping/marketplace/{marketplace_id}/get_shipping_services | 
...
- [ShippingCarrierResponse](docs/Model/ShippingCarrierResponse.md)
- [ShippingExcludeLocation](docs/Model/ShippingExcludeLocation.md)
- [ShippingExcludeLocationResponse](docs/Model/ShippingExcludeLocationResponse.md)
- [ShippingHandlingTime](docs/Model/ShippingHandlingTime.md)
- [ShippingHandlingTimeResponse](docs/Model/ShippingHandlingTimeResponse.md)
- [ShippingLocation](docs/Model/ShippingLocation.md)
- [ShippingLocationResponse](docs/Model/ShippingLocationResponse.md)
...
- [ShippingServiceResponse](docs/Model/ShippingServiceResponse.md)
